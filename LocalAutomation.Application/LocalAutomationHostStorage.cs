...
{
    /// <summary>
    /// Gets the default LocalAppData folder name used when a host does not supply a specific override.
    /// </summary>
    public const string DefaultDataFolderName = "LocalAutomation";

    /// <summary>
    /// Gets the default repo-local layered settings filename used when a host does not supply a specific override.
    /// </summary>
